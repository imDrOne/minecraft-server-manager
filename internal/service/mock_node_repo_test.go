...
// Source: github.com/imDrOne/minecraft-server-manager/internal/service (interfaces: NodeRepository)
//
// Generated by this command:
//
//	mockgen -destination mock_node_repo_test.go -package service . NodeRepository
//
